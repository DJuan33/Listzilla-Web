...
class NewGroupListModal extends StatefulWidget {
  const NewGroupListModal({Key? key}) : super(key: key);

  @override
  _NewGroupListModalState createState() => _NewGroupListModalState();
}

class _NewGroupListModalState extends State<NewGroupListModal> {
